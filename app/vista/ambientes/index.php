    ...
    <div class="col m9">
      <div class="card ">
        ...
        <div class="card-content" >
           ...
           <table id="tabla-ambientes" class="bordered highlight">
            <thead id="thead">
              <tr id="thead">
                <th width="20%">
...
<div c>
  <a class="btn-floating btn-large pulse waves-effect waves-light  red   generar-pdf">
    ...
    <script src="public/js/validaciones/ambiente.js"></script>
