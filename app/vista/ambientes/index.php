...
<main>
      ...
      <div class="card ">
        ...
        <div class="card-content row">
          <p class="col s12" style="padding: 10px 1px 1px 1px;">
            ...
            Este módulo corresponde a la gestion de Ambientes en el sistema 
          </p>

          <p class="col s12" style="padding: 10px 1px 1px 1px;">
            
              <i class="material-icons left">add</i>
            Atraves de este modulo puede crear nuevos Ambientes.
          </p>
          ...
          <p class="col s12" style="padding: 10px 1px 1px 1px;">
            ...
            Así como también consultar , modificar los datos o eliminar los Ambientes existentes en el sistema
          </p>
  ...
  <div class="fixed-action-btn">
    <a class="btn-floating btn-large pulse waves-effect waves-light  secundario   crear-ambiente">
...
<script src="public/js/validaciones/ambientes.js"></script>
<script src="public/js/ajax/menu.js"></script>
<script src="public/vendor/paginacion.js"></script>
<script src="public/js/ajax/ambientes.js"></script>
</body>
</html>