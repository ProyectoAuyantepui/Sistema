<?php $titulo = "ACTIVIDADES ADMINISTRATIVAS";?>
<!DOCTYPE html>
<html>
<head>
...
<main>
   ...
   <div class="col s12 m3">
      <div class="card ">
        ...
        <div class="center-align purple tarjeta" style="padding: 24px 0px 2px 0px;margin: 0px;">
          <img src="public/img/activities.png" alt="" class="responsive-img " width="90">
          <p class="titulo-tarjeta"  >ACTIVIDADES ADMINISTRATIVAS</p>
        </div>
        ...
        <div class="card-content row">
          ...
          <p class="col s12" style="padding: 10px 1px 1px 1px;">
            ...
            Así como también consultar , modificar los datos o eliminar las actividades administrativas existentes en el sistema
          </p>
    ...
    <div class="col m9">
      <div class="card ">
        ...
        <div class="card-content" >
           ...
           <table id="tabla_ActAdm" class="bordered highlight">
            <thead id="thead">
             <tr id="thead">
                <th >
                  <p>
  ...
  <div class="fixed-action-btn">
      <a 
        class="btn-floating btn-large waves-effect waves-light pulse light-blue lighten-1   crear-ActAdm"
      >
...
<script src="public/js/validaciones/acti-admi.js"></script>
<script src="public/js/ajax/menu.js"></script>
<script src="public/vendor/paginacion.js"></script>
<script src="public/js/ajax/acti-admi.js"></script>
</body>
</html>