/*
			...
			*/
			...
			(function ( $ ) {
				...
				{
					var pagination = "<span><button class=' btn primario paginationInit '><i class='material-icons'>first_page</i></button></span> ";
					for (var i = 1; i <= last; i++)
					{
						pagination += "<span><button class=' btn primario paginationClick '>" + i + "</button></span> ";
					}
					pagination += "<span><button class=' btn primario paginationEnd '><i class='material-icons'>last_page</i></button></span>"
